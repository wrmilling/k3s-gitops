...
## Dependencies
Renovate manages image/chart bumps (`renovate.json5` at root, extending sub-configs from `.forgejo/renovate/`); images are digest-pinned. A Claude workflow (`.forgejo/workflows/renovate-review.yml`) reviews Renovate PRs.
